import { selectedFlagImage } from './selectedFlagImage';

describe('selectedFlagImage function', () => {
  const countries = [
    {
      countryCode: 'GB',
      countryCodeISO: 'GB',
  ...
  it('should execute the function with the correct parameters', () => {
    expect(selectedFlagImage('GB', countries)).toEqual('/content/dam/global/flags/United-Kingdom.png');
  });
});
